...
⏱️ ${timers.toTimeString()}`.trim(), m)
 ...
 •  *Nama resmi:* ${info.namaResmi}
 •  *Wilayah:* ${info.wilayah}
 •  *Subwilayah:* ${info.subwilayah}
 •  *Zona waktu:* ${info.zonaWaktu.join(', ')}
 •  *Bendera:* ${info.bendera}
...
handler.help = handler.command = ['adventure','berpetualang']
handler.tags = ['rpg']
