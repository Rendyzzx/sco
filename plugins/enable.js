  ...
  case 'autodownload':
      ...
      break
        ...
        default:
            ...
            //conn.adReply(m.chat, caption, wish() + ' ' + name, '', fs.readFileSync('./media/thumbnail.jpg'), '', m)
    }
    await m.reply(`${type} berhasil ${isEnable ? 'dinyalakan': 'dimatikan'} untuk ${isAll ? 'bot ini': 'chat ini'} !`)
}
handler.help = handler.command = ["disable", "enable", "on", "off"];
